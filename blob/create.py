...
from blob.blob_model import BlobModel
...
def create(event, context):
    ...
    if 'callback_url' in event['body']:
        ...
        if not validateCallbackUrl(callback_url):
            return {
    ...
    upload_url = blob.get_upload_url()  # No timeout specified here, use member param default
...
def validateCallbackUrl(callback_url):
